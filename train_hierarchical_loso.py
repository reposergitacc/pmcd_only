#!/usr/bin/env python3
"""
PMCD-Only Hierarchical Two-Stage Training (LOSO)
=================================================
Leave-One-Subject-Out evaluation of hierarchical two-stage model on PMCD only.

Default: LOSO (49 folds x seeds). Use --fixed-folds for 5 fixed folds instead.

Example:
    python train_hierarchical_loso.py --pmcd-dir /path/to/pmcd_np --output-dir results_hier_loso --seeds 42
"""
...
def parse_args() -> argparse.Namespace:
    ...
    if args.output_dir is None:
        args.output_dir = KAGGLE_WORKING_DIR / "pmcd_hierarchical_loso" if KAGGLE_WORKING_DIR.is_dir() else Path("pmcd_hierarchical_loso")
...
def fine_tune_hierarchical(target: PainData, seed: int, fold: int,
    ...
    # Combined validation for calibration
    val_eval = (
